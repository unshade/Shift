...
class Emulator(Device):
    ...
    def __init__(self, name: str, device: str, android_version: str, data_partition: str,
        ...
        self.path_emulator_profiles = os.path.join(workdir, "docker-android", "docker",
                                                   "configs", "devices", "profiles")
        self.path_emulator_skins = os.path.join(workdir, "docker-android", "docker",
    ...
    def deploy(self):
        ...
        basic_args = "-gpu swiftshader_indirect -accel on -writable-system -verbose --dns-server 10.0.2.2"
